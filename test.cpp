...
int main()
{
	...
	for (int i(0); i < n; ++i)
	{
		cin >> input;
		tree.insert(input);
		//cout<<"search 25 "<<tree.search(25)<<std::endl;
		//cout<<"search 27 "<<tree.search(27)<<std::endl;
		//cout<<"search 23 "<<tree.search(23)<<std::endl;
		//cout << input << " ";
	}
	//cout<<"next to show"<<std::endl;
	tree.show();
